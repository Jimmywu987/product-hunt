...
import { GetStaticProps } from "next";
 ...
 const HomePage = ({posts, topics}:{posts:PostDetail[],topics:string[]})=>{
  ...
  const setStoredPosts = useSetRecoilState(storePostsState)
  ...
  return (
    <div className="container mx-auto px-1 lg:px-4 my-14">
      <div
        className="flex flex-row items-center px-3 py-2 text-sm border rounded-lg cursor-pointer border-blue-DEE7F3 text-blue-596F8D lg:hidden"
